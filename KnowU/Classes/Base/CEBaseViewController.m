...
//    [backBtn setImage:K_IMG(@"back_black") forState:UIControlStateNormal];
...
#pragma mark--跳转操作
-(void)pushController:(CEBaseViewController *)view{
    CEBaseNavViewController * base = (CEBaseNavViewController*)g_App.tabBarVC.selectedViewController;
...
{
    CEBaseNavViewController * base = (CEBaseNavViewController*)g_App.tabBarVC.selectedViewController;
    CEBaseViewController * baseView = (CEBaseViewController*)base.topViewController;
...
-(UIButton*)setNavWithTitle:(NSString *)title Font:(CGFloat)font andTextColor:(NSString*)color andIsLeft:(BOOL)isLeft andTarget:(id)target andAction:(SEL)selector
{
    ...
    finishBtn.frame = CGRectMake(0, 0,width, 55/2.0);
...
-(void)dealloc
{
    NSLog(@"%@%s释放",[self getClassName],__func__);
}
